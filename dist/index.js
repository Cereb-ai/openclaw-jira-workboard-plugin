...
const Parameters = Type.Object({
    method: Type.Optional(Type.String({
        description: "Method name. Generic 5 (0.1.0 + 0.2.0): search, get, comment, transition, block. Orchestrator 5 (0.3.0+): create_task, create_subtask, submit_verdict, escalate_task, request_help.",
    })),
...
export default definePluginEntry({
    id: PLUGIN_ID,
    name: "Jira",
    description: "Native Jira Cloud REST v3 integration for OpenClaw. Single dispatcher tool `jira` covers 10 methods: generic 5 (search / get / comment / transition / block from 0.1.0 + 0.2.0) and orchestrator 5 (create_task / create_subtask / submit_verdict / escalate_task / request_help from 0.3.0+). Reads ATST_TOKEN / JIRA_CLOUD_ID from env (no mcporter dependency). Orchestrator methods also read JIRA_DEFAULT_ASSIGNEE_ACCOUNT_ID. See skills/jira/SKILL.md for per-method guidance.",
    register(api) {
