...
const Parameters = Type.Object({
    method: Type.Optional(Type.String({
        description: "Method name. Generic 5 (0.1.0 + 0.2.0): search, get, comment, transition, block. Orchestrator 5 (0.3.0+): create_task, create_subtask, complete_task, escalate_task, request_help.",
    })),
